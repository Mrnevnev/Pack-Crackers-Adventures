...
namespace MagicPigGames.ProjectileFactory
{
    ...
    public class DestroyOrPoolObjectWithFade : DestroyOrPoolObject
    {
        ...
        protected virtual void OnValidate()
        {
            ...
            {
                Debug.LogWarning("Time to destroy must be >= fadeTime");
        ...
        protected virtual IEnumerator Fade()
        {
            ...
            yield return new WaitForSeconds(timeToDestroy - fadeTime);
        ...
        private void FadeObjects(float time)
        {
            ...
            for (var i = 0; i < _particleSystems.Count; i++)
            {
                ...
                tempColor.a = Mathf.Clamp01(tempColor.a); // Clamp alpha between 0 and 1, just in case
                startColor.color = tempColor;
                var byteAlpha = (byte)(tempColor.a * 255); // Convert float to byte
                main.startColor = startColor;

                if (particles.Length < _particleSystems[i].particleCount)
                    particles = new ParticleSystem.Particle[_particleSystems[i].particleCount];

                var fetchedParticles = _particleSystems[i].GetParticles(particles);
                ...
                _particleSystems[i].SetParticles(particles, fetchedParticles);
                    ...
                    _particleSystemRenderers[i].renderMode == ParticleSystemRenderMode.Mesh)
                {
                    ...
                    {
                        // Assuming you want to fade the entire particle system
                    ...
                    {
                        // Assuming you want to shrink the entire particle system
        ...
        protected virtual void CacheObjectValues()
        {
            ...
            {
                var main = ps.main;
                _particleSystemAlphas.Add(main.startColor.color.a);
