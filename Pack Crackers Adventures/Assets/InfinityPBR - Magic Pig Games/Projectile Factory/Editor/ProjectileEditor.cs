...
namespace MagicPigGames.ProjectileFactory
{
    ...
    public class ProjectileEditor : InfinityEditor
    {
        ...
        private void DrawProjectileData()
        {
            ...
            FlexibleSpace();
            Target.projectileData = Object(Target.projectileData, typeof(ProjectileData)) as ProjectileData;
            ReplaceDuplicateProjectileData(Target.projectileData);
            if (tempDataObject != Target.projectileData) ExitGUI();
            EndRow();
        ...
        private void DrawSpawnBehavior()
        {
            ...
            Target.SpawnBehavior = Object(Target.SpawnBehavior, typeof(SpawnBehavior)) as SpawnBehavior;
            ReplaceDuplicateSpawnBehavior(Target.SpawnBehavior);
            if (tempDataObject != Target.SpawnBehavior)
                ExitGUI();
        ...
        {
            CloneAndReplaceAsset(obj, newObj => { Target.projectileData = newObj; });
        }

        private void ReplaceDuplicateSpawnBehavior(SpawnBehavior obj)
        {
            CloneAndReplaceAsset(obj, newObj => { Target.SpawnBehavior = newObj; });
        }
